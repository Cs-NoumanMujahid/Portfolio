  ...
  return (
    ...
    >
      ...
      >
        ...
        ></div>
        <div
          className="absolute top-[20%] right-[10%] w-[20%] h-[20%] bg-neon-green/5 rounded-full blur-[60px] animate-pulse"
        ...
        <img
          ...
          alt="Overlay"
          className="absolute inset-0 w-full h-full object-cover opacity-10 mix-blend-overlay will-change-transform"
        />
      </motion.div>
      ...
      >
        ...
        >
          Engineering{' '}
          <span className="text-neon-blue font-medium italic underline decoration-neon-blue/40 underline-offset-8">
            Intelligent
          </span>{' '}
          Web Architectures at the intersection of AI & Design.
        </motion.h2>
